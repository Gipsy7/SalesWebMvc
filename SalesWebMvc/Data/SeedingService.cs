...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department(5, "Music");

            Seller s1 = new Seller(1, "José Silva", "ze@gmail.com", new DateTime(1998, 04, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Rosa Lima", "limarosa@gmail.com", new DateTime(1979, 12, 31), 2000.0, d2);
            Seller s3 = new Seller(3, "Heraldo Cunha", "cunha_h@gmail.com", new DateTime(1988, 01, 15), 1500.0, d3);
            Seller s4 = new Seller(4, "Roberto Justus", "rjustus@gmail.com", new DateTime(1993, 11, 30), 1450.0, d4);
            Seller s5 = new Seller(5, "Leopolda Brandão", "leopoldabr@gmail.com", new DateTime(2000, 01, 9), 2300.0, d2);
            Seller s6 = new Seller(6, "Charlie Brown Junior", "cbjr@gmail.com", new DateTime(1970, 04, 9), 30000.0, d5);
